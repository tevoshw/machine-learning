...
@st.cache_resource
def load_assets():
    model = joblib.load("src/projects/Classification/YoutubeSpam Project/model_nb.pkl")
    cv = joblib.load("src/projects/Classification/YoutubeSpam Project/vectorizer.pkl")
    return model, cv
